...
function changeScene(newScene) {
  ...
  //scene[lastScene].interactive = false;
  //scene[currentScene].interactive = false;
  ...
  var sceneFadeInterval = setInterval( function() {
    ...
    if (elapsedTime < animationTime) {
      ...
      scene[currentScene].setFade(elapsedTime/animationTime);
    }
    // Finished animation
    else {
      //scene[lastScene].interactive = true;
      //scene[currentScene].interactive = true;
